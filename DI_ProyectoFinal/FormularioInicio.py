...
class FormularioInicio(Gtk.Window):
    ...
    def __init__(self):
        ...
        Gtk.Window.__init__(self, title="Tienda Los Martínez")
        ...
        formularios = ["Gestión Socios", "Gestión Tienda"]
...
class GestionCliente(Gtk.Window):
    ...
    def dni_cliente(self):
        ...
        tiendaC = sqlite3.connect("tiendaDB.dat")
    ...
    def on_insertar_clicked(self, btn):
        ...
        tienda = sqlite3.connect("TiendaDB.dat")
...
class TablaClientes(Gtk.Window):
    ...
    def on_informe(self, btnIn):
        Videoclub = sqlite3.connect("TiendaDB.dat")
        cursor = Videoclub
...
class TablaServicios(Gtk.Window):
    ...
    def on_factura(self, btnIn):
        tiendaRe = sqlite3.connect("TiendaDB.dat")
        cursor = tiendaRe
